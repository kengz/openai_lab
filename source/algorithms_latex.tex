...
Select $A_{t+1}$ in state $S_{t+1}$ using policy $Q(S_t, A_t) \Leftarrow Q(S_t, A_t) + \alpha [R_{t+1} + \gamma Q(S_{t+1}, A_{t+1}) - Q(S_t, A)]$
...
\subsection{Off Policy Expected Sarsa}
